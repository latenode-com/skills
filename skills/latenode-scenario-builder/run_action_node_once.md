...
The public [MCP Tools Reference](https://documentation.latenode.com/mcp-server/tools) may temporarily lag behind this newly released tool. The schema and behavior below follow the current reference supplied with this skill package.
