...
<b>ℹ️ This scenario was generated using Latenode MCP</b><br>
For detailed documentation on working with MCP, see the <a href="https://docs.latenode.com">Latenode Docs</a>.<br>
Have questions? Head over to our <a href="https://community.latenode.com/latest">Community</a> — we'd be happy to see you there!
</div>
```
